...
def main():
    ...
    # mlflow.set_experiment("Resnet18 Single-Channel")  # Set experiment name
    # mlflow.autolog()
    # with mlflow.start_run(run_name="Resnet18 Single-Channel Training and Testing") as run:
        # Log parameters
    ...
    torch.save(model.state_dict(), "/raid/student/2021/ai21btech11005/vipcup/classification_from_old_server/classification_models/models/resnet18_single_channel_model.pth")
    ...
    with open("/raid/student/2021/ai21btech11005/vipcup/classification_from_old_server/classification_models/testing/resnet18_single_channel_testing.txt", "w") as f:
