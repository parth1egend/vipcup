...
def main():
    ...
    # Load and modify AlexNet model for single-channel input
    ...
    # mlflow.set_experiment("AlexNet Single-Channel")  # Set experiment name
    # mlflow.autolog()
    # with mlflow.start_run(run_name="AlexNet Single-Channel Training and Testing") as run:
        # Log parameters
    ...
    torch.save(model.state_dict(), "/raid/student/2021/ai21btech11005/vipcup/classification_from_old_server/classification_models/models/alexnet_single_channel_model.pth")
    ...
    with open("/raid/student/2021/ai21btech11005/vipcup/classification_from_old_server/classification_models/testing/alexnet_single_channel_testing.txt", "w") as f:
