...
def main():
    ...
    # mlflow.set_experiment("Resnet34 3 Channel")  # Set experiment name
    # mlflow.autolog()
    # with mlflow.start_run(run_name="Resnet34 3 Channel Training and Testing") as run:
        # Log parameters
    ...
    torch.save(model.state_dict(), "/raid/student/2021/ai21btech11005/vipcup/classification_from_old_server/classification_models/models/resnet34_3stacked_model.pth")
    ...
    with open("/raid/student/2021/ai21btech11005/vipcup/classification_from_old_server/classification_models/testing/resnet34_3stacked_testing.txt", "w") as f:
