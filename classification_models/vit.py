...
def main():
    set_seed(42)
    # Define paths
    train_dataset_path = "/home/ai21btech11019/vipcup/classification_models/EDSR_Data"
    ...
    train_dataset, test_dataset = train_test_split(full_dataset, test_size=0.1, random_state=42)
    ...
    # mlflow.set_experiment("Vit Single-Channel")  # Set experiment name
    # mlflow.autolog()
    # with mlflow.start_run(run_name="Vit Single-Channel Training and Testing") as run:
        # Log parameters
    ...
    torch.save(model.state_dict(), "/home/ai21btech11019/vipcup/classification_models/models/vit_single_channel_model.pth")
    ...
    with open("/home/ai21btech11019/vipcup/classification_models/testing/vit_single_channel_testing.txt", "w") as f:
